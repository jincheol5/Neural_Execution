...
class Model_Trainer:
    ...
    @staticmethod
    def compute_bf_accuracy(prec,dist,prec_label,dist_label):
            ...
            for val_graph_type,val_graph_list in val_graph_list_dict.items():
                ...
                for val_graph in val_graph_list:
                    ...
                    while t < N:
                        ...
                        step_acc=Model_Trainer.compute_bfs_accuracy(y=cls_y,label=x_t)
                    ...
                    last_acc=Model_Trainer.compute_bfs_accuracy(y=last_y,label=last_x_label)
